...
function displayLiveHeader($header)
{ ?>
...
function printLobby($header, $bestOF, $id1, $name1, 
...
WHERE M.id=?";
    ...
    return array($data[0][0],$data[0][1],$data[0][2],$data[0][3],$data[0][4],$data[0][5],$data[0][6],$data[0][7],$data[0][8],$data[0][9],$data[0][10]);
}
